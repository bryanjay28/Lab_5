...
//		Sound.beep();
		 ...
		 * block was found
		 */
//		this.navigation.travelTo(this.lowerLeftX, this.upperRightY, false, this);
//		
//		this.navigation.travelTo(this.upperRightX, this.upperRightY, false, this);
//		this.navigation.travelTo(this.upperRightX, this.lowerLeftY, false, this);
//		this.navigation.travelTo(this.lowerLeftX, this.lowerLeftY, false, this);
